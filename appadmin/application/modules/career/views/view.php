                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input required name="news_indo" type="text" class="form-control pull-right" value="<?=$news_tittle_indo?>">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input required name="news" type="text" class="form-control pull-right" value="<?=$news_tittle?>">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group col-lg-4">
